...
6. If a message is about creating / placing a purchase order or ordering more of something, classify it as "create_po". This is different from need_request (which just shows what's low). create_po means the user wants to actually create a purchase order for a specific item.
